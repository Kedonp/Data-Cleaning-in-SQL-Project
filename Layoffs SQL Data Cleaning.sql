...
-- Creating v3 table with new column for coumting duplicates
USE world_layoffs;
...
-- 3. Checking columns for erros and standardizing data
...
-- 3. Find null or blank values and filling them appropriately 
SELECT *
FROM world_layoffs.layoffs_v3
